...
- (void)requestToken
{
    ...
    /* Try to load a stored requestToken from settings (useful for iPhone) */
...
//        // Save the token in case we exit and start again before the token is authorized (useful for iPhone)
//        NSURL *url = [NSURL URLWithString:[NSString
//                                           stringWithFormat:@"%@authorize?oauth_token=%@&oauth_callback=%@",
